...
var validation_exception_formatter_util_1 = require("../utils/validation-exception-formatter.util");
var ValidationExceptionFilter = function () {
    var _classDecorators = [(0, common_1.Catch)(validation_exception_1.ValidationException)];
    ...
    var ValidationExceptionFilter = _classThis = /** @class */ (function () {
        ...
        ValidationExceptionFilter_1.prototype.catch = function (exception, host) {
            ...
            var formattedError = (0, validation_exception_formatter_util_1.validationExceptionFormatter)(exception);
