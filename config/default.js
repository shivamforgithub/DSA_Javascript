...
exports.db = exports.ENV_PARAMS = exports.retryTimes = void 0;
var dotenv = require("dotenv");
var common_enum_1 = require("../src/enums/common.enum");
dotenv.config();
exports.retryTimes = {
    numberOfRetries: 3,
    minTimeOut: 6000,
...
exports.ENV_PARAMS = {
    ...
    mandateWebhookAcceptedEventName: process.env.MANDATE_WEBHOOK_ACCEPTED_EVENT_NAME,
    ...
    generalAwsQueueConsumerInstances: process.env.GENERAL_AWS_QUEUE_CONSUMER_INSTANCES,
    ...
    repaymentAwsQueueConsumerInstances: process.env.REPAYMENT_AWS_QUEUE_CONSUMER_INSTANCES,
    ...
    awsDlqLightApiConsumerInstances: process.env.AWS_DLQ_LIGHT_API_CONSUMER_INSTANCES,
    ...
    lightTechStatusReportRecipients: process.env.LIGHT_TECH_STATUS_REPORT_RECIPIENTS,
    ...
    videoKycInitiatedSmsTemplateId: process.env.VIDEO_KYC_INITIATED_SMS_TEMPLATE_ID,
    ...
    hypervergeWebhookAuthorizationToken: process.env.HYPERVERGE_WEBHOOK_AUTHORIZATION_TOKEN,
    ...
    eSignLoanManagerSignServerUrl: process.env.E_SIGN_LOAN_MANAGER_SIGN_SERVER_URL,
    ...
    equifaxCreditBureauRequestData: process.env.EQUIFAX_CREDIT_BUREAU_REQUEST_DATA,
...
exports.db = {
    synchronize: exports.ENV_PARAMS.env.toLocaleLowerCase() === common_enum_1.SYSTEM_ENV.LOCAL,
    poolsize: 10,
};
